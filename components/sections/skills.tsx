      ...
      >
        <div className="grid gap-12 lg:grid-cols-[1fr_1.2fr] lg:items-center">
          ...
          <div className="space-y-4">
            ...
            <h2 className="text-slate-900 dark:text-slate-100 text-3xl font-semibold md:text-4xl">
              Languages, libraries, frameworks and tools I use in development
            </h2>
            <p className="text-slate-600 dark:text-slate-300 text-base">
              I’m a product-focused developer. Strong type safety, good tests,
              and following design systems help me move fast and safely with
              teams.
            </p>
          </div>

          {/* Sağ taraf - Skill listeleri */}
